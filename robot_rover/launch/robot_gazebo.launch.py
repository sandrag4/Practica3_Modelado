...
def generate_launch_description():
    ...
    pkg_path = get_package_share_directory('robot_rover')
    ...
    model_paths = get_model_paths(['robot_rover'])

    robot_rover_launcher = IncludeLaunchDescription(
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("robot_rover"), "rviz", "robot.rviz"]
    )
    ...
    ld.add_action(robot_rover_launcher)
